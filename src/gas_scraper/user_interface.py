...
def display_region_menu():
    ...
    console.print(Panel(table, title="[bold white]SELECT REGION[/]", expand=False, border_style="blue"))
...
def display_results(df):
    ...
    console.print(Panel("🏆 VIEW 2: CHEAPEST OVERALL (SORTED)", style="bold gold1", expand=False))
